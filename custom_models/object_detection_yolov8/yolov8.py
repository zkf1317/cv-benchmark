...
import numpy as np
import onnxruntime
from onnxruntime.quantization.quant_utils import model_has_infer_metadata
...
from custom_models.object_detection_yolov8.tools import xywh2xyxy, multiclass_nms, detections_dog

class YoloV8:
    def __init__(self, model_path, conf_thres=0.7, iou_thres=0.5, backendId = ModelInferBackend.CPU):
